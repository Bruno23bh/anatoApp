...
describe('FormulariosPage', () => {
  ...
  it('should add formulario', () => {
    component.filesHasChanged(mockedPagos[0].files);
    expect(component.organizacion.formularios.length).toEqual(1);
  });

  it('should put a formulario', () => {
  ...
  it('should get error when putting a formulario', () => {
